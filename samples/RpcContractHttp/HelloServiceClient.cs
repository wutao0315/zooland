...
//    public HelloServiceClientTest(ILogger<IHelloService> logger, IZooyardPools zooyardPools, IEnumerable<IInterceptor> interceptors)
//    {
//        _declaringType = typeof(IHelloService);
//        var zooyardAttr = _declaringType.GetCustomAttribute<ZooyardAttribute>();
//        _invoker = new ZooyardInvoker(logger, zooyardPools, interceptors, zooyardAttr);
