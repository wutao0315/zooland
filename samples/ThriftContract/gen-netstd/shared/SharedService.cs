...
namespace shared
{
  public partial class SharedService
  {
    ...
    {
      global::System.Threading.Tasks.Task<global::shared.SharedStruct> getStructAsync(int key, CancellationToken cancellationToken = default);
    ...
    public class Client : TBaseClient, IDisposable, IAsync
    {
      ...
      public async global::System.Threading.Tasks.Task<global::shared.SharedStruct> getStructAsync(int key, CancellationToken cancellationToken = default)
      {
        await OutputProtocol.WriteMessageBeginAsync(new TMessage("getStruct", TMessageType.Call, SeqId), cancellationToken);
        
        var args = new InternalStructs.getStructArgs() {
          Key = key,
        };
        ...
        var result = new InternalStructs.getStructResult();
    ...
    public class InternalStructs
    {
      ...
      public partial class getStructArgs : TBase
      {
        ...
        public getStructArgs DeepCopy()
        {
          var tmp2 = new getStructArgs();
          if(__isset.key)
          {
            tmp2.Key = this.Key;
          }
          tmp2.__isset.key = this.__isset.key;
          return tmp2;
        }
        ...
        {
          if (!(that is getStructArgs other)) return false;
      ...
      public partial class getStructResult : TBase
      {
        ...
        public getStructResult DeepCopy()
        {
          var tmp4 = new getStructResult();
          if((Success != null) && __isset.success)
          {
            tmp4.Success = (global::shared.SharedStruct)this.Success.DeepCopy();
          }
        ...
        public override bool Equals(object that)
        {
          if (!(that is getStructResult other)) return false;
          if (ReferenceEquals(this, other)) return true;
