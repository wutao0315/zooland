...
public partial class RpcConnection
{
    ...
    private static partial class Log
    {
        ...
        public static void SendingMessage(ILogger logger, RpcMessage message)
        {
            if (logger.IsEnabled(LogLevel.Debug))
            {
                if (message is RpcInvocationMessage invocationMessage)
                {
        ...
        public static void MessageSent(ILogger logger, RpcMessage message)
        {
            if (logger.IsEnabled(LogLevel.Debug))
            {
                if (message is RpcInvocationMessage invocationMessage)
        ...
        [LoggerMessage(21, LogLevel.Debug, "RpcConnection stopped.", EventName = "Stopped")]
        ...
        [LoggerMessage(24, LogLevel.Information, "Using RpcProtocol '{Protocol} v{Version}'.", EventName = "RpcProtocol")]
        public static partial void RpcProtocol(ILogger logger, string protocol, int version);
        ...
        [LoggerMessage(28, LogLevel.Debug, "Sending Rpc Handshake.", EventName = "SendingRpcHandshake")]
        public static partial void SendingRpcHandshake(ILogger logger);
        ...
        [LoggerMessage(41, LogLevel.Debug, "Starting RpcConnection.", EventName = "Starting")]
        ...
        [LoggerMessage(44, LogLevel.Information, "RpcConnection started.", EventName = "Started")]
        ...
        [LoggerMessage(52, LogLevel.Debug, "Stopping RpcConnection.", EventName = "Stopping")]
        ...
        [LoggerMessage(67, LogLevel.Error, "The RpcConnection failed to transition from the {ExpectedState} state to the {NewState} state because it was actually in the {ActualState} state.", EventName = "StateTransitionFailed")]
        public static partial void StateTransitionFailed(ILogger logger, RpcConnectionState expectedState, RpcConnectionState newState, RpcConnectionState actualState);

        [LoggerMessage(68, LogLevel.Information, "RpcConnection reconnecting.", EventName = "Reconnecting")]
        public static partial void Reconnecting(ILogger logger);

        [LoggerMessage(69, LogLevel.Error, "RpcConnection reconnecting due to an error.", EventName = "ReconnectingWithError")]
        public static partial void ReconnectingWithError(ILogger logger, Exception exception);

        [LoggerMessage(70, LogLevel.Information, "RpcConnection reconnected successfully after {ReconnectAttempts} attempts and {ElapsedTime} elapsed.", EventName = "Reconnected")]
        ...
        [LoggerMessage(80, LogLevel.Trace, "The RpcConnection is attempting to transition from the {ExpectedState} state to the {NewState} state.", EventName = "AttemptingStateTransition")]
        public static partial void AttemptingStateTransition(ILogger logger, RpcConnectionState expectedState, RpcConnectionState newState);
        ...
        [LoggerMessage(93, LogLevel.Debug, "RpcProtocol '{Protocol} v{Version}' does not support Stateful Reconnect. Disabling the feature.", EventName = "DisablingReconnect")]
