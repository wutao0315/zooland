...
namespace Zooyard.Rpc.Support
{
    public abstract class AbstractPool : IPool
    {
        ...
        /// 连接缓存池
        /// </summary>
        protected Queue<IClient> clientsPool;
        ...
        /// 配置键值
        /// </summary>
        public SerConfig Config { set; get; }
        ...
        /// 通信超时时间，单位毫秒
        /// </summary>
        public int ClientTimeout { set; get; }
        ...
        protected AbstractPool(string[] hosts, SerConfig config)
        {
            //参数校验及赋值
            if (hosts == null)
            {
        ...
        /// </summary>
        /// <returns>连接</returns>
        public virtual IClient BorrowClient()
        {
        ...
        public virtual void ReturnClient(IClient client)
        {
            lock (locker)
            {
        ...
        /// </summary>
        /// <param name="client">连接</param>
        protected void EnqueueClient(IClient client)
        {
        ...
        /// </summary>
        /// <returns>连接</returns>
        protected IClient DequeueClient()
        {
        ...
        /// </summary>
        /// <returns>连接</returns>
        protected virtual IClient CreateClient(string hostInfo)
        {
            return null;
        }
        ...
        /// </summary>
        /// <returns>连接</returns>
        protected IClient InitializeClient(out Exception err)
        {
            err = null;
            if (Hosts.Length == 0)
            {
            ...
            for (var i = 0; i < Hosts.Length; i++)
            {
                try
                {
                    ...
                    IClient client = CreateClient(Hosts[hostIndexs[j]]);
