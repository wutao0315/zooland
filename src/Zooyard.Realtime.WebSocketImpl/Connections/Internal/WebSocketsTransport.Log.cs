...
internal sealed partial class WebSocketsTransport
{
    private static partial class Log
    {
        ...
        [LoggerMessage(20, LogLevel.Warning, $"Configuring request headers using {nameof(WebSocketConnectionOptions)}.{nameof(WebSocketConnectionOptions.Headers)} is not supported when using websockets transport " +
