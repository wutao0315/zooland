...
public partial class WebSocketConnection
{
    internal static partial class Log
    {
        ...
        public static partial void ErrorStartingTransport(ILogger logger, string transport, Exception exception);
        ...
        public static void TransportDoesNotSupportTransferFormat(ILogger logger, string transport, TransferFormat transferFormat)
        {
        ...
        public static partial void TransportStarted(ILogger logger, string transport);
