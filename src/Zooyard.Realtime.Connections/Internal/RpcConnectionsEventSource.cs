...
internal sealed class RpcConnectionsEventSource : EventSource
{
    public static readonly RpcConnectionsEventSource Log = new RpcConnectionsEventSource();
    ...
    internal RpcConnectionsEventSource()
        : base("Microsoft.AspNetCore.Http.Connections")
    {
    }

    // Used for testing
    internal RpcConnectionsEventSource(string eventSourceName)
