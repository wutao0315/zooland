...
internal sealed class DefaultHttpRequest : HttpRequest
{
    ...
    private IRequestBodyPipeFeature RequestBodyPipeFeature =>
        _features.Fetch(ref _features.Cache.BodyPipe, HttpContext, _newRequestBodyPipeFeature)!;
    ...
    public override string Path {
        get { return HttpRequestFeature.Path; }
        set { HttpRequestFeature.Path = value ?? string.Empty; }
    }
