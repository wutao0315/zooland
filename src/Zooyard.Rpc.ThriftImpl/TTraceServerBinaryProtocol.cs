...
namespace Zooyard.Rpc.ThriftImpl
{
    public class TTraceServerBinaryProtocol : TBinaryProtocol
    {
        ...
        public TTraceServerBinaryProtocol(TServerTransport transport) : base(transport)
        {
    ...
    public static class Factory : TProtocolFactory
    {
        public TProtocol getProtocol(TTransport trans)
        {
            return new TTraceServerProtocol(trans);
        }
    }
}
