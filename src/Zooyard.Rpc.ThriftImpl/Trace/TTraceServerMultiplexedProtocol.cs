...
{
    public class TTraceServerMultiplexedProtocol : TMultiplexedProtocol
    {

        private IDictionary<string, string> HEAD_INFO;

        public TTraceServerMultiplexedProtocol(TProtocol protocol, string serviceName) : base(protocol, serviceName)
        {
