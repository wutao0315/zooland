...
{
    public class TTraceClientMultiplexedProtocol : TMultiplexedProtocol
    {

        private IDictionary<string, string> HEAD_INFO;

        public TTraceClientMultiplexedProtocol(TProtocol protocol, string serviceName) : base(protocol, serviceName)
        {
