...
{
    public static IRpcBuilder AddConfigBuilder(this IRpcBuilder builder, Dictionary<string, Type> baseReturnTypes, IResultTranslate resultTranslate)
    {
        ...
        builder.Services.TryAddSingleton<IZooyardPools>((serviceProvder) =>
        {
            ...
            var zooyardPools = new ZooyardPools(loggerfactory, clientPools, loadBalances, clusters, caches, routeFactories, lookup, baseReturnTypes, resultTranslate);
            return zooyardPools;
        });
