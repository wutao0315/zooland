...
public sealed partial class StringUtils
{
    private static readonly Regex KVP_PATTERN = MyRegex();  //key value pair pattern.
    ...
    [GeneratedRegex("([_.a-zA-Z0-9][-_.a-zA-Z0-9]*)[=](.*)", RegexOptions.Compiled)]
