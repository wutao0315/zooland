 ...
 * @since 3.0
 */
    public class BitList<E> : IList<E>
    {
        public E this[int index] { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
        ...
        //private readonly BitSet rootSet;
