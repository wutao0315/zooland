...
/// </summary>
public static class RpcDependencyInjectionExtensions
{
    /// <summary>
    ...
    public static ISignalRServerBuilder AddSignalRCore(this IServiceCollection services)
    {
        ...
        services.TryAddSingleton(typeof(IRpcProtocolResolver), typeof(DefaultHubProtocolResolver));
