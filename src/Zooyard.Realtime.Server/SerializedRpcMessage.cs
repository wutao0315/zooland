...
/// </summary>
public class SerializedRpcMessage
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="SerializedRpcMessage"/> class.
    /// </summary>
    /// <param name="messages">A collection of already serialized messages to cache.</param>
    public SerializedRpcMessage(IReadOnlyList<SerializedMessage> messages)
    {
    ...
    public SerializedRpcMessage(RpcMessage message)
    {
        Message = message;
    }

    /// <summary>
    /// Gets the serialized representation of the <see cref="RpcMessage"/> using the specified <see cref="IRpcProtocol"/>.
    /// </summary>
    /// <param name="protocol">The protocol used to create the serialized representation.</param>
    /// <returns>The serialized representation of the <see cref="RpcMessage"/>.</returns>
