...
public partial class HubConnectionContext
{
    ...
    private readonly object _receiveMessageTimeoutLock = new ();
    ...
    /// </summary>
    public virtual IRpcProtocol Protocol { get; set; } = default!;
    ...
    /// <summary>
    /// Write a <see cref="RpcMessage"/> to the connection.
    /// </summary>
    /// <param name="message">The <see cref="RpcMessage"/> being written.</param>
    ...
    public virtual ValueTask WriteAsync(RpcMessage message, CancellationToken cancellationToken = default)
    {
        return WriteAsync(message, ignoreAbort: false, cancellationToken);
    }

    internal ValueTask WriteAsync(RpcMessage message, bool ignoreAbort, CancellationToken cancellationToken = default)
    {
...
#pragma warning restore CA2016
    ...
    private ValueTask<FlushResult> WriteCore(RpcMessage message, CancellationToken cancellationToken)
    {
        try
        {
    ...
    private async Task WriteSlowAsync(RpcMessage message, bool ignoreAbort, CancellationToken cancellationToken)
    {
...
#pragma warning restore CA2252 // This API requires opting into preview features
    ...
    internal async Task<bool> HandshakeAsync(TimeSpan timeout, IReadOnlyList<string>? supportedProtocols, IRpcProtocolResolver protocolResolver,
...
#pragma warning restore CA2252 // This API requires opting into preview features
    ...
    internal bool ShouldProcessMessage(RpcMessage message)
    {
        if (UsingStatefulReconnect())
        {
